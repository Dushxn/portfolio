...
// Update the theme toggle button to have a better icon for light/dark mode
    ...
    >
      <div className="container mx-auto flex items-center justify-between p-4">
        <div className="flex items-center">
          ...
          {/* Replace the CiDark icon with conditional rendering based on theme */}
          <button
            onClick={toggleTheme}
        ...
        {isMenuOpen && (
          <motion.div
            className="absolute top-full left-0 right-0 bg-bg-color/95 backdrop-blur-lg md:hidden"
          ...
          >
            <div className="flex flex-col p-4 space-y-4">
              <a href="#AboutMe" className="p-2 hover:text-accent-color-1 transition-colors" onClick={closeMenu}>
                About me
              </a>
              <a href="#Skills" className="p-2 hover:text-accent-color-1 transition-colors" onClick={closeMenu}>
                Skills
              </a>
              <a href="#Projects" className="p-2 hover:text-accent-color-1 transition-colors" onClick={closeMenu}>
                Projects
              </a>
              <a
                className="BTN bg-accent-color-2 p-2 rounded-lg text-white font-semibold text-center hover:bg-accent-color-1 transition-colors"
                href="#ContactMe"
                onClick={closeMenu}
              >
                Contact Me
